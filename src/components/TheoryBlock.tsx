...
export function TheoryBlock({ level }: TheoryBlockProps) {
  ...
  const paths: Record<string, string> = {
    '0': '/exercises/00-setup/_internal/README.md',
    '1': '/exercises/01-basic-form/_internal/README.md',
    '2': '/exercises/02-validation/_internal/README.md',
    '3': '/exercises/03-schema-validation/_internal/README.md',
    '4': '/exercises/04-complex-fields/_internal/README.md',
    '5': '/exercises/05-dynamic-forms/_internal/README.md',
    '6': '/exercises/06-states-ux/_internal/README.md',
    '7': '/exercises/07-async/_internal/README.md',
    '8': '/exercises/08-advanced/_internal/README.md',
  }
