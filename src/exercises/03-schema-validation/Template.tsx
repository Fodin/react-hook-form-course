...
export function Task3_1_Template() {
  ...
  resolver: zodResolver(schema)
      ...
      {/* ============================================================
          ...
          1. Импортируйте z из 'zod' и zodResolver из '@hookform/resolvers/zod'
          2. Создайте Zod схему с 4 полями: email, password, confirmPassword, age
          3. Используйте .refine() для проверки совпадения паролей
          4. Подключите zodResolver к useForm
          ============================================================ */}
    </TaskBlock>
  )
}
...
export function Task3_2_Template() {
  ...
  password: yup.string().min(8).required()
      ...
      {/* ============================================================
          ...
          1. Импортируйте yup и yupResolver из '@hookform/resolvers/yup'
          2. Создайте Yup схему с теми же полями что в задании 3.1
          3. Используйте .oneOf() для проверки совпадения паролей
          4. Сравните синтаксис Zod и Yup в комментариях
          ============================================================ */}
    </TaskBlock>
  )
}
...
export function Task3_3_Template() {
  ...
  bio: "Опытный разработчик..."
      ...
      {/* ============================================================
          ...
          1. Создайте сложную Zod схему с вложенными объектами и массивами
          2. personalInfo: объект с firstName, lastName, age
          3. contacts: массив объектов { type, value }
          4. skills: массив строк (минимум 1), role: enum
          5. bio: опционально, максимум 500 символов
          ============================================================ */}
    </TaskBlock>
  )
}
...
export function Task3_4_Template() {
  ...
  path: ["confirm"]
      ...
      {/* ============================================================
          ...
          1. Создайте схему с 3 полями: currentPassword, newPassword, confirmPassword
          2. Используйте .refine() для проверки совпадения паролей
          3. Добавьте .refine() для проверки что новый пароль отличается от текущего
          4. Укажите кастомные сообщения об ошибках для каждого refine
          ============================================================ */}
    </TaskBlock>
  )
}
...
export function Task3_5_Template() {
  return (
    <TaskBlock taskNumber="3.5" title="Сравнение Zod vs Yup">
      ...
      {/* ============================================================
          TODO: Напишите анализ в комментариях перед этим TaskBlock
          
          1. Ответьте на 5 вопросов из Requirements выше
          2. Опишите преимущества и недостатки каждой библиотеки
          3. Сделайте вывод какую библиотеку выбрали бы для проекта
          ============================================================ */}
    </TaskBlock>
  )
}
