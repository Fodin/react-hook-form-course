...
export function Task7_1_Template() {
  ...
  return busy.includes(value) ? 'Занято' : true
      ...
      {/* ============================================================
          ...
          1. Создайте функцию validateUsername с имитацией API (задержка 500-1000ms)
          2. Занятые имена: admin, user, test
          3. Используйте onBlur для запуска async валидации
          4. Отображайте статус: "Проверка..." / "✅ Доступно" / "❌ Занято"
          ============================================================ */}
    </TaskBlock>
  )
}
...
export function Task7_2_Template() {
  ...
  bio: string
      ...
      {/* ============================================================
          ...
          1. Загрузите данные пользователя в useEffect (имитация API)
          2. После загрузки вызовите reset(data) для заполнения формы
          3. Отображайте состояние загрузки "Загрузка..."
          4. Кнопка "Сохранить" активна только при isDirty
          ============================================================ */}
    </TaskBlock>
  )
}
...
export function Task7_3_Template() {
  ...
  message: string
      ...
      {/* ============================================================
          ...
          1. Создайте 3 поля: name, email, message
          2. Кнопка disabled во время отправки (isSubmitting)
          3. Текст кнопки: "Отправка..." / "Отправить"
          4. Обработайте ошибку и успех после отправки
          ============================================================ */}
    </TaskBlock>
  )
}
...
export function Task7_4_Template() {
  ...
  return () => clearTimeout(timer)
      ...
      {/* ============================================================
          ...
          1. Используйте useEffect с setTimeout для debounce (1 секунда)
          2. Сохраняйте данные в localStorage при изменении
          3. Отображайте индикатор "✓ Сохранено"
          4. Восстанавливайте данные из localStorage при загрузке
          ============================================================ */}
    </TaskBlock>
  )
}
