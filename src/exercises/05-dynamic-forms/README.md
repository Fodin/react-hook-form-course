...
Динамические формы — это формы, которые меняются в зависимости от действий пользователя. Вы научитесь добавлять/удалять поля, создавать многошаговые формы и отображать условные поля.
...
**useFieldArray** — это хук для работы с динамическими массивами полей. Позволяет добавлять, удалять, перемещать поля в форме.
