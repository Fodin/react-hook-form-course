...
/>`}
      ...
      {/* ============================================================
          ...
          1. Создайте кастомный компонент Select с options
          2. Используйте Controller для интеграции Select с формой
          3. Добавьте валидацию: country — обязательное поле
          4. Отображайте ошибку валидации под селектором
          ============================================================ */}
    </TaskBlock>
  )
}
...
export function Task4_2_Template() {
  ...
  country: 'USA' | 'Russia' | 'Germany' | 'France'
      ...
      {/* ============================================================
          ...
          1. Создайте radio кнопки для gender (male, female, other)
          2. Создайте select для country (USA, Russia, Germany, France)
          3. Добавьте валидацию: оба поля обязательные
          4. Отображайте выбранное значение под формой
          ============================================================ */}
    </TaskBlock>
  )
}
...
export function Task4_3_Template() {
  ...
  skills: string[]
      ...
      {/* ============================================================
          ...
          1. Создайте одиночный checkbox agree "Согласен с правилами"
          2. Создайте множественный checkbox для skills (React, Vue, Angular, Svelte)
          3. agree — обязательное, skills — минимум один выбран
          4. Отображайте выбранные навыки
          ============================================================ */}
    </TaskBlock>
  )
}
...
export function Task4_4_Template() {
  ...
  size: v => v[0]?.size < 2 * 1024 * 1024
      ...
      {/* ============================================================
          ...
          1. Создайте input type="file" для загрузки avatar
          2. Добавьте валидацию: тип image/* и размер < 2MB
          3. Реализуйте предпросмотр изображения после выбора
...
export function Task4_5_Template() {
  ...
  appointment: string
      ...
      {/* ============================================================
          ...
          1. Создайте input type="date" для birthDate
          2. Создайте input type="datetime-local" для appointment
          3. birthDate: пользователь должен быть старше 18 лет
          4. appointment: не может быть в прошлом
          ============================================================ */}
    </TaskBlock>
  )
}
